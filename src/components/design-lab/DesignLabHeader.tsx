        ...
        <div className="relative z-10 space-y-4">
          ...
          <div>
            <h1 className="text-2xl sm:text-4xl font-black tracking-tight text-white flex items-center gap-3">
              ...
              <span>MiniMarket Design Lab</span>
            </h1>
            <p className="text-stone-300 text-sm sm:text-base mt-2 max-w-3xl leading-relaxed">
              Compará y evaluá 3 propuestas de Design System para MiniMarket en tiempo real. Todos los componentes y datos son compartidos y utilizan tokens visuales independientes.
            </p>
          </div>
