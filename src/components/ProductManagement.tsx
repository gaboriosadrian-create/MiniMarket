...
import { SmartCatalogImportModal } from './smart-catalog/SmartCatalogImportModal';
...
export const ProductManagement: React.FC<ProductManagementProps> = ({ onNavigateToTab }) => {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              ...
              id="btn-new-product"
              className="inline-flex items-center justify-center space-x-2 px-4 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-sm shadow-xs transition-colors shrink-0 cursor-pointer"
            >
            ...
            <button
              ...
              id="btn-import-smart-catalog"
              className="inline-flex items-center justify-center space-x-2 px-4 py-2.5 rounded-xl bg-emerald-50 text-emerald-800 hover:bg-emerald-100 border border-emerald-300 font-bold text-sm shadow-xs transition-colors shrink-0 cursor-pointer"
            >
            ...
            <button
              ...
              className="inline-flex items-center justify-center space-x-1.5 px-3 py-2.5 rounded-xl bg-stone-100 hover:bg-stone-200 text-stone-700 font-semibold text-xs border border-stone-200 transition-colors shrink-0 cursor-pointer"
              title="Descargar archivo modelo de Excel con instrucciones"
            >
            ...
            <form onSubmit={handleCreateProduct} className="space-y-4 text-sm max-h-[75vh] overflow-y-auto pr-1">
              ...
              <div className="flex flex-col sm:grid sm:grid-cols-2 gap-3.5">
                <div className="w-full space-y-1.5">
                  <div className="flex items-center justify-between">
                    <label className="block text-xs font-bold uppercase text-stone-700">Código de Barras (Opcional)</label>
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="flex-1 min-w-0 px-3 py-2 border border-stone-300 rounded-xl font-mono focus:ring-2 focus:ring-emerald-500 focus:outline-none text-xs"
                    />
                    <button
                      type="button"
                      onClick={() => setScannerTarget('create')}
                      className="shrink-0 px-3 py-2 bg-stone-900 hover:bg-stone-800 active:scale-95 text-white rounded-xl flex items-center justify-center gap-1.5 cursor-pointer shadow-xs transition-all text-xs font-bold min-h-[38px]"
                ...
                <div className="w-full space-y-1.5">
                  <label className="block text-xs font-bold uppercase text-stone-700">Categoría</label>
                  <input
                    type="text"
          ...
          <div className="bg-white rounded-2xl max-w-lg w-full p-6 shadow-2xl border border-stone-200 space-y-4">
            ...
            <form onSubmit={handleUpdateProduct} className="space-y-4 text-sm max-h-[75vh] overflow-y-auto pr-1">
              ...
              <div className="flex flex-col sm:grid sm:grid-cols-2 gap-3.5">
                <div className="w-full space-y-1.5">
                  <div className="flex items-center justify-between">
                    <label className="block text-xs font-bold uppercase text-stone-700">Código de Barras</label>
                    <span className="text-[10px] text-stone-400">Preserva ceros iniciales</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="flex-1 min-w-0 px-3 py-2 border border-stone-300 rounded-xl font-mono text-xs focus:ring-2 focus:ring-emerald-500 bg-white"
                    />
                    <button
                      type="button"
                ...
                <div className="w-full space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-stone-300 rounded-xl focus:ring-2 focus:ring-emerald-500 text-xs bg-white"
                  />
                  ...
                  {editForm.category.trim() && (() => {
                    ...
                    if (match && match.toLowerCase() === editForm.category.trim().toLowerCase() && match !== editForm.category.trim()) {
                      return (
                        <div className="mt-1.5 text-[11px] text-indigo-700 bg-indigo-50 border border-indigo-200 rounded-lg px-2.5 py-1 flex items-center gap-1.5">
                          <Info className="w-3.5 h-3.5 text-indigo-500 shrink-0" />
                          <span>La categoría <strong>"{match}"</strong> ya existe. Se seleccionó la categoría existente.</span>
                        </div>
                      );
                  ...
                  <div className="flex flex-wrap gap-1.5 mt-2 max-h-20 overflow-y-auto">
                    {categories.slice(0, 8).map(cat => (
                      <button
                        ...
                        className={`text-[10px] px-2.5 py-1 rounded-lg border flex items-center gap-1 cursor-pointer transition-colors ${
      ...
      {/* Smart Catalog Import Wizard Modal */}
      <SmartCatalogImportModal
