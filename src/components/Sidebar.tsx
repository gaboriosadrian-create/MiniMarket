      ...
      >
        ...
        <div className="h-16 bg-stone-900 flex items-center justify-center border-b border-stone-800 p-2 shrink-0">
          <button
            ...
            className="w-10 h-10 rounded-xl bg-stone-800 hover:bg-stone-700 active:scale-95 text-white flex items-center justify-center font-bold shadow-xs transition-all cursor-pointer p-1.5 border border-stone-700"
        ...
        {/* User Avatar & Notifications Mini */}
        <div className="p-2 flex flex-col items-center gap-1.5 border-b border-stone-200 bg-stone-50">
      ...
      <div className="h-16 px-4 bg-stone-900 text-white flex items-center justify-between border-b border-stone-800 shrink-0">
        <div className="flex items-center space-x-3 min-w-0">
          ...
          <div className="min-w-0 flex-1">
            <h2 className="font-black text-base tracking-tight text-white leading-tight lowercase">
              uwi
            </h2>
        ...
        {/* Notifications & Close/Collapse Button */}
