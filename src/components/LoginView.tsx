    ...
    <div className="min-h-screen flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: 'var(--mm-color-bg)' }}>
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="flex justify-center">
          <div className="w-12 h-12 rounded-2xl bg-[#006AFF] text-white flex items-center justify-center font-bold shadow-xs">
            <Store className="w-7 h-7" />
          </div>
        </div>
        <h2 className="mt-3 text-center text-2xl sm:text-3xl font-black text-stone-900 tracking-tight">
          MiniMarket
        </h2>
        <p className="mt-1 text-center text-xs sm:text-sm text-stone-500 font-medium">
          Sistema profesional de punto de venta y gestión comercial
        </p>
      </div>
