...
import { Store, ArrowLeft, Home, FileQuestion, AlertCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-stone-100 flex flex-col items-center justify-center p-4 selection:bg-blue-200">
      <div className="w-full max-w-md bg-white rounded-3xl border border-stone-200 shadow-sm p-6 sm:p-8 text-center space-y-6 animate-in fade-in zoom-in-95">
        ...
        <div className="flex items-center justify-center space-x-2">
          <div className="w-8 h-8 rounded-xl bg-[#0057FF] text-white flex items-center justify-center font-bold text-xs shadow-2xs">
            <Store className="w-4 h-4" />
          </div>
          <span className="text-base font-black tracking-tight text-stone-900">MiniMarket</span>
        </div>
        ...
        <div className="pt-2 border-t border-stone-100">
          <p className="text-[11px] text-stone-400 font-medium">
            MiniMarket · Sistema de Gestión de Productos
          </p>
        </div>
