...
export const SuperAdminDashboard: React.FC = () => {
  ...
  const [activeView, setActiveView] = useState<'businesses' | 'design-lab'>('businesses');
      ...
      <div className="flex items-center justify-between bg-stone-900/90 text-white p-3 rounded-2xl border border-stone-800 text-xs">
        <div className="flex items-center gap-2">
          ...
          <button
            type="button"
            onClick={() => setActiveView('businesses')}
            className="px-3 py-1 rounded-lg bg-purple-600 text-white font-bold cursor-pointer"
          >
            🏢 Gestión de Negocios
          </button>
          <button
