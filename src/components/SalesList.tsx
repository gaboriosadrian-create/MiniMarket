            ...
            <div className="grid grid-cols-2 gap-2 text-xs bg-stone-50 p-3 rounded-xl border border-stone-200">
              ...
              <div>
                ...
                {selectedSale.paymentMethod === 'COMBINADO' && selectedSale.paymentBreakdown && (
                  <div className="mt-1 text-[11px] space-y-0.5 text-stone-600 font-medium">
                    <div>💵 Efectivo: <strong className="text-stone-900">{formatCurrency(selectedSale.paymentBreakdown.cashAmount)}</strong></div>
                    <div>📱 Mercado Pago: <strong className="text-stone-900">{formatCurrency(selectedSale.paymentBreakdown.mpAmount)}</strong></div>
