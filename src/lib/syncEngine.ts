...
import { syncPurchaseOperationToFirestore, syncCancelPurchaseOperationToFirestore } from './purchaseService';
...
class SyncEngine {
  ...
  private async dispatchOperationSync(op: OutboxOperation): Promise<{
    ...
    switch (opType) {
      ...
      case 'PURCHASE':
        return syncPurchaseOperationToFirestore(opToSync);
      case 'CANCEL_PURCHASE':
        return syncCancelPurchaseOperationToFirestore(opToSync);
      default:
