...
export interface BusinessVisualTheme {
  themeId: string;
  updatedAt?: string;
  updatedBy?: string;
}
...
export interface Business {
  ...
  visualTheme?: BusinessVisualTheme;
  themeId?: string;
}

export type AdminInvitationStatus = 'PENDING' | 'ACTIVE' | 'CANCELLED';
...
export type RegisterAdminInput = InviteAdminInput;
...
export type CashFlowType = 'INCOME' | 'EXPENSE' | 'NEUTRAL';
