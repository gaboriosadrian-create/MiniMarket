/**
 * MiniMarket Service Worker (PWA Phase 1)
 * Provides static shell caching, offline startup capability, and update management.
 */

const CACHE_VERSION = 'minimarket-v1.0.0';
const STATIC_CACHE_NAME = `mm-static-${CACHE_VERSION}`;
const DYNAMIC_CACHE_NAME = `mm-dynamic-${CACHE_VERSION}`;
